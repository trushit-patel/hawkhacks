...
function JobRoleSuggester() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setResponseText("Error suggesting job roles.");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-20">
      <div className="bg-white shadow-md px-8 pt-6 pb-8 mb-4 rounded-3xl">
        <h1 className="text-3xl font-bold mb-6">Job Role Suggester</h1>
...
export default JobRoleSuggester;
